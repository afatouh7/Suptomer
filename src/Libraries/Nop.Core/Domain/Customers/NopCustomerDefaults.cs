...
public static partial class NopCustomerDefaults
{
    ...
    public static string SuptomerMerchantRoleName => "SuptomerMerchant";
    public static string SuptomerSupplierRoleName => "SuptomerSupplier";
    ...
    public static string WorkingDaysFrom => nameof(WorkingDaysFrom);
    public static string WorkingDaysTo => nameof(WorkingDaysTo);
    public static string DayOff => nameof(DayOff);
    public static string MobileNumber => nameof(MobileNumber);
    public static string ShipmentEmail => nameof(ShipmentEmail);
    public static string TimeFrameFrom => nameof(TimeFrameFrom);
    public static string TimeFrameTo => nameof(TimeFrameTo);
    public static string SupplierDocs => nameof(SupplierDocs);
    public static string NationalId => nameof(NationalId);
    public static string Signature => nameof(Signature);

    public static string ContactPersonName => nameof(ContactPersonName);
    public static string BudgetValue => nameof(BudgetValue);
    public static string BudgetLimitInterval => nameof(BudgetLimitInterval);
    public static string BranchName => nameof(BranchName);
    public static string BranchManager => nameof(BranchManager);
    public static string BranchMobileNumber => nameof(BranchMobileNumber);
    public static string BranchTimeFrameFrom => nameof(BranchTimeFrameFrom);
    public static string BranchTimeFrameTo => nameof(BranchTimeFrameTo);
    public static string BranchTimeZone => nameof(BranchTimeZone);
    #endregion
}