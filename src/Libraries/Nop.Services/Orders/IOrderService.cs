...
public partial interface IOrderService
{
    ...
    Task<IPagedList<Order>> SearchOrdersAsync(int storeId = 0,
        ...
        string orderNotes = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false, string shippingCity = null);

    Task<decimal> GetOrdersIncomeAsync(int storeId = 0,
        int vendorId = 0, int customerId = 0,
        int productId = 0, int affiliateId = 0, int warehouseId = 0,
        int billingCountryId = 0, string paymentMethodSystemName = null,
        DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
