...
public partial class OrderService : IOrderService
{
        ...
        string shippingCity = null)
    {
        ...
        {
            query = from o in query
                    join oba in _addressRepository.Table on o.ShippingAddressId equals oba.Id
                    where
                    oba.City.Contains(shippingCity) ||
                    oba.Address1.Contains(shippingCity) ||
                    oba.Address2.Contains(shippingCity)
                    select o;
        }
    ...
    public virtual async Task<decimal> GetOrdersIncomeAsync(int storeId = 0,
        int vendorId = 0, int customerId = 0,
        int productId = 0, int affiliateId = 0, int warehouseId = 0,
        int billingCountryId = 0, string paymentMethodSystemName = null,
        DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
        ...
        string orderNotes = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false)
    {
        ...
        //database layer paging
        return await query.SumAsync(o => o.OrderTotal);
    }
