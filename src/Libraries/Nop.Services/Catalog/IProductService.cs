...
public partial interface IProductService
{
    ...
    /// <summary>
    /// Gets featured product category by a productId
    /// </summary>
    ...
    Task<IPagedList<Product>> GetProductsAsync(int storeId = 0, int pageIndex = 0, int pageSize = int.MaxValue);
    ...
    /// The task result contains the result
    /// </returns>
    Task AddSuplierContractAsync(SupplierContract  supplierContract);
    ...
    /// <param name="productId">Product identifier</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task<IList<SupplierContract>> GetAllContractForMerchantByEmail(string email);
    /// <summary>
    ...
    Task<List<ProductsAboutToExpireDto>> GetTop3AboutToExpireProducts(int vendorId);
}