...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        /// </returns>
        Task<IList<Warehouse>> GetAllWarehousesAsync(int? userId, string name = null);
        ...
        /// </returns>
        Task<Warehouse> GetNearestWarehouseAsync(int? userId, Address address, IList<Warehouse> warehouses = null);
