...
public partial class CustomerModelFactory : ICustomerModelFactory
{
    ...
    public virtual Task<SupplierSearchModel> PrepareSupplierSearchModelAsync(SupplierSearchModel searchModel)
    {
        if (searchModel == null)
    ...
    public virtual async Task<SupplierGridVM> PrepareSupplierListModelAsync(SupplierSearchModel searchModel)
    {
        if (searchModel == null)
            throw new ArgumentNullException(nameof(searchModel));
        ...
        var suppliers = (await _customerService.GetAllCustomersAsync(customerRoleIds: new[] { vendorRole.Id }))
            .ToPagedList(searchModel);

        var model = new SupplierGridVM().PrepareToGrid(searchModel, suppliers, () =>
        {
            return suppliers.Select(s => new SupplierListVM
            {
