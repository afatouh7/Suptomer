...
public partial interface IOrderModelFactory
{
    ...
    Task<PaymentSearchModel> PreparePaymentSearchModelAsync(PaymentSearchModel searchModel);

    Task<PaymentGridVM> PreparePaymentListModelAsync(PaymentSearchModel searchModel);
}
