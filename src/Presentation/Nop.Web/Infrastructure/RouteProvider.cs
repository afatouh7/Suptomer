...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(name: "MerchantPage ",
        pattern: $"{lang}",
        defaults: new { controller = "Home", action = "MerchantPage" });


        //Supplier profile route
        endpointRouteBuilder.MapControllerRoute(name: "SupplierPage ",
        pattern: $"{lang}",
        defaults: new { controller = "Home", action = "SupplierPage" });


        //Select Persona page
        // new { controller = "MyNewPage", action = "Index" },
        endpointRouteBuilder.MapControllerRoute(name: "Persona",
            pattern: $"{lang}",
            defaults: new { controller = "Personas", action = "Index" });
        //login
